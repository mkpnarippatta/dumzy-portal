...
function simulateClassification(message) {
  ...
  } else if (msg.includes('ticket') || msg.includes('concert') || msg.includes('event') || msg.includes('show') || msg.includes('movie') || msg.includes('bus ticket') || msg.includes('air ticket') || msg.includes('flight') || msg.includes('train ticket')) {
